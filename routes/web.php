...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    Route::middleware(['auth', 'role:Admin'])->group(function () {
        ...
        */
        ...
        Route::get('/documents/schema/load/',[DocumentTypeController::class,'load_schema'])->name('documents.schema.load');
        Route::get('/documents/{name}/schema/load/{id?}',[DocumentTypeController::class,'load_schema'])->name('documents.schema.load.document');
    });
    ...
    */
    ...
    Route::get('/documents/files/rename',[FileController::class,'rename'])->name('documents.files.root.rename');
    Route::get('/documents/{name}/files/rename',[FileController::class,'rename'])->name('documents.files.rename');
});
